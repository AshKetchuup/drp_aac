...
class _ProfileSetupState extends State<ProfileSetup> {
  ...
  static const List<Map<String, dynamic>> avatarOptions = [
    {'id': 'avatar_1', 'icon': Icons.face, 'color': Color(0xFF3B82F6)},
    {'id': 'avatar_2', 'icon': Icons.face_2, 'color': Color(0xFFA855F7)},
    {'id': 'avatar_3', 'icon': Icons.face_3, 'color': Color(0xFF22C55E)},
    {'id': 'avatar_4', 'icon': Icons.face_4, 'color': Color(0xFFF97316)},
    {'id': 'avatar_5', 'icon': Icons.face_5, 'color': Color(0xFFEC4899)},
    {'id': 'avatar_6', 'icon': Icons.face_6, 'color': Color(0xFF14B8A6)},
  ];
