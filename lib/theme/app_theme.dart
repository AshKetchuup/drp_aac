...
class AppTheme {
  ...
  // Category Colors
  static const Color categoryPronoun = Color(0xFFFACC15); // Yellow
  static const Color categoryVerb = Color(0xFF22C55E); // Green
  static const Color categoryNoun = Color(0xFFF97316); // Orange
  static const Color categoryAdjective = Color(0xFF3B82F6); // Blue
  static const Color categoryActivity = Color(0xFFA855F7); // Purple
  static const Color categoryFood = Color(0xFFEC4899); // Pink
